...
namespace ProcessorsToolkit.Model.Forms
{
    internal class PRMGForm : PDFFormBase
    {

        public PRMGForm(FormTypes formType, FannieData srcBorrData, BorrDir borrDir)
        {
            FormType = formType;
        ...
        public static string LenderkName = "Paramount Residential Mortgage Group";
        public static string LenderAddrFull = "1265 Corona Pointe Ct. Suite 301, Corona, CA 92879";
            ...
            var vals = new Dictionary<string, string>
                {
                    ...
                    {"Borr2_DOB", srcBorrData.BorrDOB_Pretty},
                    ...
                    {"Lender_Name_Addr", (LenderkName + ", " + LenderAddrFull)},
