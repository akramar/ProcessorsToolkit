...
namespace ProcessorsToolkit.Model.Interbank.FormFiller
{
    internal class Form : PDFFormBase
    {
        ...
        public Form(FormTypes formType, FannieData srcBorrData, BorrDir borrDir)
        {
            ...
            LenderName = "Interbank Mortgage Company";
            LenderNameShort = "IBW";
            LenderAddrFull = "333 Knightsbridge Parkway, Suite 210, Lincolnshire, IL 60069";
        }
        ...
        public override void Fill()
        {
            ...
            if (FormFieldsVals == null)
                throw new Exception("Form data null");
